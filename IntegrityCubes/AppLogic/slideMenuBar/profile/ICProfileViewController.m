...
//    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(cubeFeedRowDeleteSuccess:) name:NOTIFICATION_DELETE_CUBE_FEED_SUCCESS object:nil];
    ...
    [[NSNotificationCenter defaultCenter]addObserver:self selector:@selector(gotoSearchProfile:) name:NOTIFICATION_GO_BACK_TO_PROFILE object:nil];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    if ([type isEqualToString:@"s"]) {
        ...
        [imgVCubeReciever setImage:[UIImage imageNamed:@"MultipleTeam"]];
        ...
        ICLikeCommentButton *btnRightViewProfile=(ICLikeCommentButton*)[cell.contentView viewWithTag:17];
        btnRightViewProfile.index= myCubeFeedDHolder.intSenderId;
        btnRightViewProfile.tag= [myCubeFeedDHolder.strCubeFeedId integerValue];
        btnRightViewProfile.group_type = myCubeFeedDHolder.strCubeType;
        [btnRightViewProfile addGestureRecognizer:imageTapped];
        lblReceiverName.text=nil;
    }
...
-(void)gotoSearchProfile:(NSNotification*)notification{
    ...
    [self performSegueWithIdentifier:@"viewProfile" sender:notification.userInfo];
}
