...
- (BOOL)gestureRecognizerShouldBegin:(UIGestureRecognizer *)gestureRecognizer{
    ...
    FPTouchView *fpTouchView = [gestureRecognizer.view.subviews objectAtIndex:0];
    CGPoint point = [gestureRecognizer locationInView:fpTouchView];
    CGRect rect = CGRectMake(fpTouchView.frame.origin.x,fpTouchView.frame.origin.y+70,fpTouchView.frame.size.width , fpTouchView.frame.size.height-70);
